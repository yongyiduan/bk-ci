...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async requestList () {
                try {
                    const res = await this.$store.dispatch('store/requestServiceVisableList', this.serviceCode)
            ...
            saveHandle (params) {
                ...
                this.$store.dispatch('store/setServiceVisableDept', { params }).then(() => {
                    this.requestList()
                }).catch((err) => {
            ...
            async requestDeleteVisiable (deptIds) {
                let message, theme
                try {
                    await this.$store.dispatch('store/requestDeleteServiceVis', {
