<template>
    <div class="member-manage-wrapper">
        ...
        <add-member-dialog :show-dialog="showDialog"
            :project-code="currentService.projectCode"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async requestList () {
                try {
                    const res = await this.$store.dispatch('store/requestServiceMemList', this.serviceCode)
            ...
            async confirmHandle (params) {
                let message, theme
                try {
                    await this.$store.dispatch('store/requestAddServiceMem', Object.assign(params, { storeCode: this.serviceCode }))
            ...
            async requestDeleteMember (id) {
                let message, theme
                try {
                    await this.$store.dispatch('store/requestDeleteServiceMem', {
