    ...
    <bk-exception :type="infoMap.typeMap[exceptionType] || '403'" class="exception-home">
        <section class="exception-content">
            ...
            <span class="exception-title">
                ...
                <bk-link theme="primary" target="_blank" href="https://iwiki.woa.com/x/pZMdK" v-if="exceptionType === 520">{{$t('exception.learnMore')}}</bk-link>
                <bk-link theme="primary" target="_blank" href="https://iwiki.woa.com/x/EkgKKw" v-if="exceptionType === 403">{{$t('exception.learnMore')}}</bk-link>
            </span>
